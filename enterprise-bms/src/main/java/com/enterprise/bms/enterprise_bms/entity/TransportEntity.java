// Updated TransportEntity.java (add new fields only; replace the entire class with this)
...
public class TransportEntity {
    ...
    private String invoiceStatus = "Not Invoiced"; // ENUM('Not Invoiced', 'Invoiced', 'Paid')
    // ------------------- Auto Timestamp -------------------
    @PrePersist
